...
const Navbar = () => {
  ...
  const pages = [
    { name: "Focus Zone", path: "/focus-zone" },
    { name: "Destress Zone", path: "/destress-zone" },
    { name: "Colab Zone", path: "/colab-zone" },
    { name: "Study Zone", path: "/study-zone" },
    { name: "CogniChat", path: "/cognichat" },
    { name: "Serenity Zone", path: "/serenity-zone" }
  ];
    ...
    <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
      <div className="navbar-container">
        ...
        <div className={`navbar-links ${mobileMenuOpen ? "open" : ""}`}>
          {pages.map((page) =>
            page.name === "Services" ? (
              <div key={page.name} className="dropdown-container">
              ...
              <a key={page.name} href={page.path} className="nav-link">
                {page.name}
              </a>
            )
          )}
